...
import { updateVendorProfileSchema } from "interfaceAdapters/validations/vendor.validation";
import { editWorkSampleSchema, workSampleSchema } from "interfaceAdapters/validations/work-sample.validation";
...
export class VendorController implements IVendorController{
    ...
    async getVendorwalletDetails(req: Request, res: Response): Promise<void> {
        ...
        const walletDetails = await this._getVendorWalletDetailsUseCase.execute(id,type,Number(page),Number(limit))
