...
const update_personal_information_usecase_1 = require("@usecases/client/update-personal-information.usecase");
...
class UseCaseRegistry {
    static registerUseCases() {
        ...
        tsyringe_1.container.register("IUpdatePersonalInformationUseCase", {
            useClass: update_personal_information_usecase_1.ClientUpdatePersonalInformationUseCase,
        });
        ...
        tsyringe_1.container.register("IUpdateVendorPersonalInformationUseCase", {
            useClass: update_vendor_personal_information_usecase_1.UpdateVendorPersonalInformationUseCase,
        });
