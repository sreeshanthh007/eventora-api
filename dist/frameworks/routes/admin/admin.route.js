...
class AdminRotes extends base_route_1.BaseRouter {
    ...
    initializeRoutes() {
        ...
        this.router.get("/vendors", auth_middleware_1.verifyAuth, (0, async_handler_1.asyncHandler)(resolver_1.adminVendorController.getAllVendors.bind(resolver_1.adminVendorController)));
        ...
        this.router.patch("/vendor-status", auth_middleware_1.verifyAuth, (0, async_handler_1.asyncHandler)(resolver_1.adminVendorController.udpateVendorAccountStatus.bind(resolver_1.adminVendorController)));
