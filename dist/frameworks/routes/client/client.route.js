...
class ClientRoutes extends base_route_1.BaseRouter {
    ...
    initializeRoutes() {
        ...
        this.router.get("/all-categories", (0, async_handler_1.asyncHandler)(resolver_1.clientController.getAllCategories.bind(resolver_1.clientController)));
        ...
        // );
        this.router.get("/event-details/:eventId", (0, async_handler_1.asyncHandler)(resolver_1.clientController.getEventDetails.bind(resolver_1.clientController)));
        ...
        this.router.post("/logout", auth_middleware_1.verifyAuth, (0, auth_middleware_1.authorizeRole)(["client"]), (0, async_handler_1.asyncHandler)(resolver_1.authController.logout.bind(resolver_1.authController)));
    }
}
