...
class ClientRoutes extends base_route_1.BaseRouter {
    ...
    initializeRoutes() {
        ...
        this.router.post("/update-profileImage", auth_middleware_1.verifyAuth, (0, auth_middleware_1.authorizeRole)(["client"]), (0, async_handler_1.asyncHandler)(resolver_1.clientController.updateProfileImage.bind(resolver_1.clientController)));
        this.router.patch("/update-profile", auth_middleware_1.verifyAuth, (0, auth_middleware_1.authorizeRole)(["client"]), (0, async_handler_1.asyncHandler)(resolver_1.clientController.updateProfileInformation.bind(resolver_1.clientController)));
