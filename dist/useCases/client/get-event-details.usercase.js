...
let GetEventDetailsUseCase = class GetEventDetailsUseCase {
    ...
    execute(eventId) {
        return __awaiter(this, void 0, void 0, function* () {
            const eventExist = yield this._eventRepo.findEventByIdForDetailsPage(eventId);
            if (!eventExist) {
                throw new custom_error_1.CustomError(constants_1.ERROR_MESSAGES.ID_NOT_FOUND, constants_1.HTTP_STATUS.BAD_REQUEST);
            }
            const mappedEvent = (0, EventMapper_1.mapEventsToEventDetailPage)(eventExist);
            return mappedEvent;
        });
    }
};
