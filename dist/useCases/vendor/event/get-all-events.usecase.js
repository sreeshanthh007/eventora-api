...
let GetAllEventsUseCase = class GetAllEventsUseCase {
    ...
    execute(limit, searchTerm, current) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { events, total } = yield this._eventRepo.findPaginatedEvents(filter, skip, limit);
            const mappedEvents = events.map(EventMapper_1.mapEventEntityToTable);
            const response = {
                events: mappedEvents,
...
exports.GetAllEventsUseCase = GetAllEventsUseCase = __decorate([
