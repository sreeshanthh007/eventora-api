...
let EditCategoryUseCase = class EditCategoryUseCase {
    ...
    execute(categoryId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const categoryExist = yield this._categoryRepo.findById(categoryId);
            if (!categoryExist) {
                throw new custom_error_1.CustomError("category not found", constants_1.HTTP_STATUS.NOT_FOUND);
            }
            yield this._categoryRepo.findByIdAndEditCategory(categoryId, data);
        });
    }
};
