...
let RegisterUseCase = class RegisterUseCase {
    constructor(clientRegister, vendorRegister) {
        this.clientRegister = clientRegister;
        this.vendorRegister = vendorRegister;
        this.strategies = {
    ...
    execute(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield strategies.register(user);
        });
    }
};
...
exports.RegisterUseCase = RegisterUseCase = __decorate([
    ...
    __param(1, (0, tsyringe_1.inject)("VendorRegisterStrategy")),
