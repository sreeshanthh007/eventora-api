...
let LogoutController = class LogoutController {
    constructor(revokeRefreshTokenUseCase, blackListTokenUseCase) {
    ...
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            res.status(constants_1.HTTP_STATUS.OK).json({ success: true, message: constants_1.SUCCESS_MESSAGES.USER_LOGOUT_SUCCESS });
            return;
        });
    }
};
...
exports.LogoutController = LogoutController = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)("IRevokeRefreshTokenUseCase")),
    __param(1, (0, tsyringe_1.inject)("IBlacklistTokenUseCase")),
